        ...
        <div class="container" role="main">
            <div class="row">
                ...
                <div class="col-md-4 col-sm-4 col-xs-12">
                    <form action="" method="POST" class="form-main  form-inline nofloat-xs pull-right pull-left-sm">
                        <div class="col-md-10 col-sm-10 col-xs-12">
                            <label class="sr-only" for="search">Suche</label>
                            <div class="input-group">
                                <input type="text" class="form-control input-search" name="search" id="search"
                                       placeholder="Suche">
                                <span class="input-group-addon group-icon"><span
                        ...
                        <div class="col-md-2 col-sm-2 col-xs-12">
                            <button type="submit" class="btn btn-success">
                                <span class="glyphicon glyphicon-search" aria-hidden="true"></span><span
                                    class="hidden-sm hidden-xs">Suchen</span>
                            </button>
                        </div>
                    </form>
                </div>
