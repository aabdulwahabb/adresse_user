...
class XentralUserFactory extends Factory
{
    ...
    public function definition(): array
    {
        return [
            ...
            'passwordmd5' => $this->faker->regexify('[A-Za-z0-9]{40}'),
            'passwordsha512' => $this->faker->regexify('[A-Za-z0-9]{40}'),
            'passwordhash' => $this->faker->regexify(bcrypt('[A-Za-z0-9]{40}')),
            'salt' => '',
            'password' => '',
            'repassword' => 0,
            'remember_token' => $this->faker->regexify('[A-Za-z0-9]{40}'),
            'firma' => 1,
